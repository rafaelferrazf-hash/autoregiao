...
export default function Login() {
  ...
  return (
    <main style={{ fontFamily: "'DM Sans', sans-serif", background: "#F7F6F3", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      {/* NAVBAR */}
      <nav style={{ background: "#fff", borderBottom: "1px solid #E8E6E1", height: 60, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 24px", flexShrink: 0 }}>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 24px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0, maxWidth: 900, width: "100%", background: "#fff", borderRadius: 16, overflow: "hidden", boxShadow: "0 4px 32px rgba(0,0,0,0.08)", border: "1px solid #E8E6E1" }}>

          {/* LADO ESQUERDO — FORM */}
          <div style={{ padding: "48px 40px" }}>
            <div style={{ marginBottom: 32 }}>
              <h1 style={{ fontFamily: "Georgia, serif", fontSize: 26, fontWeight: 800, color: "#1A1917", marginBottom: 6 }}>Bem-vindo de volta!</h1>
              <p style={{ fontSize: 14, color: "#7A7670", lineHeight: 1.5 }}>Entre na sua conta para acessar seus anúncios e favoritos.</p>
            </div>

            {/* TABS */}
            <div style={{ display: "flex", gap: 0, marginBottom: 28, background: "#F7F6F3", borderRadius: 8, padding: 4 }}>
              <button style={{ flex: 1, padding: "8px 0", borderRadius: 6, border: "none", background: "#fff", fontSize: 13.5, fontWeight: 600, color: "#1A1917", cursor: "pointer", boxShadow: "0 1px 4px rgba(0,0,0,0.08)" }}>Entrar</button>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <button style={{ flex: 1, padding: "10px", border: "1.5px solid #E8E6E1", borderRadius: 8, background: "#fff", fontSize: 13, fontWeight: 500, color: "#1A1917", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
          ...
          {/* LADO DIREITO — BANNER */}
          <div style={{ background: "#1A1917", padding: "48px 40px", display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "absolute", bottom: -40, left: -40, width: 200, height: 200, background: "radial-gradient(circle, rgba(232,93,38,0.1) 0%, transparent 70%)", pointerEvents: "none" }}></div>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p style={{ fontSize: 14, color: "#7A7670", lineHeight: 1.65, marginBottom: 32 }}>
                Mais de 1.200 veículos de lojistas verificados da sua região. Negocie direto, sem intermediários.
              </p>

              {[["✅", "Lojas verificadas pela AutoRegião"],
                ["📍", "Veículos perto de você"],
                ["💬", "Chat direto com o lojista"],
                ["🔒", "Negociação segura e transparente"]].map(([icon, text]) => (
